                            ...
                            <li key={item.id} className="justify-content-between align-items-center gap-2 mb-1">
                                ...
                                <div className='d-flex justify-content-between align-items-center gap-2 itemcolor'>
                                    ...
                                    <div className="d-flex align-items-center gap-2">
                                        ...
                                        <button className="btn btn-secondary btn-sm" disabled={!item.is_available} data-bs-toggle="modal" data-bs-target="#saladModal" onClick={() => onItemAdd(item.id)}>
...
function Basket(items, onItemRemove) {
    ...
    return (
        <div className="d-flex flex-column align-items-center gap-4">
            ...
            <Link to={"/checkout"} className="btn btn-secondary btn-sm">
                Checkout
            </Link>
        </div>
    );
...
function OrderPage() {
    ...
    useEffect(() => {
        ...
        async function GetAvailableItems() {
            const [items, _] = await GetItemsFromServer()
